USE master;
GO
drop database if exists PrsDb; -- Checks to see if db already exists
GO
CREATE DATABASE PrsDb; -- Creates the DB
GO
USE PrsDb;
GO
...
VALUES
    ('ASUS', 'Asus', '800 Corporate Way', 'Fremont', 'CA', '94539', '18004541234', 'support@asus.com'),
    ('APPL', 'Apple', '1 Apple Way', 'Cupertino', 'CA', '95321', '18005052779', 'vendors@apple.com'),
    ('GOGL', 'Google', '300 Google Park', 'San Jose', 'CA', '94551', '1800505531', 'support@google.com'),
    ('DELL', 'Dell', '500 Broad St', 'Austin', 'TX', '64332', '18005453200', 'help@dell.com'),
    ('FORD', 'Ford', '5 Ford St', 'Detroit', 'Mi', '49000', '18005053873', 'parts@ford.com'),
    ('TESL', 'Tesla', '420 Tesla St', 'Austin', 'TX', '60999', '18005453221', 'sales@tesla.com'),
    ('pPGg', 'Proctor and Gamble', '500 4th St', 'Cincinnati', 'OH', '45201', '18004045991', 'vendors@pg.com'),
    ('MSFT', 'Microsoft', '1 Microsoft St', 'Seattle', 'CA', '92112', '18005051234', 'service@microsoft.com'),
    ('BIC', 'Bic', '421 5th Street', 'New York', 'NY', '00021', '18005255400', 'sales@bic.com'),
    ('DNMF', 'DundlerMiffin', '5342 Broadway', 'Scranton', 'CA', '34543', '5345405555', 'mscott@dundermiffin.com'),
    ('MIOCOC', 'Microcenter', '9500 Mosteller Rd', 'Sharonville', 'CA', '45239', '5135554545', 'cin@microcenter.com')
    ;
select * from vendors
